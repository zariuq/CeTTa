...
def main() -> int:
    ...
    cases = [
        (
            "pure-syntax",
            '(rho-file->canon "tests/rhocalc/pure_rho.rho")',
            "rho",
            "tests/rhocalc/pure_rho.rho",
            2,
            "yes",
        ),
        (
            "shadowing",
            '(rho-file->canon "tests/rhocalc/rho_shadowing.rho")',
            "rho",
            "tests/rhocalc/rho_shadowing.rho",
            3,
            "yes",
        ),
        (
            "commented-quote-inner",
            '(rho-file->canon "tests/rhocalc/rho_quote_inner_binder_restores_scope.rho")',
            "rho",
            "tests/rhocalc/rho_quote_inner_binder_restores_scope.rho",
            2,
            "yes",
        ),
        (
            "syntax-name-output",
            '(rho-file->canon "tests/rhocalc/rho_name_output.rho")',
            "rho",
            "tests/rhocalc/rho_name_output.rho",
            1,
            "yes",
        ),
        (
            "syntax-open-name-variable",
            '(rho-file->canon "tests/rhocalc/rho_open_name_variable.rho")',
            "rho",
            "tests/rhocalc/rho_open_name_variable.rho",
            1,
            "yes",
        ),
        (
            "quote-seals-outer-binder",
            '(rho-file->canon "tests/rhocalc/rho_quote_seals_outer_binder.rho")',
            "rho",
            "tests/rhocalc/rho_quote_seals_outer_binder.rho",
            1,
            "yes",
        ),
        (
        ...
        (
            "syntax-name-output-core-witness",
            '(rho-file->canon "tests/rhocalc/rho_name_output.rho")',
            "mrho",
        ...
        (
            "syntax-name-output-vs-name-pass-negative",
            '(rho-file->canon "tests/rhocalc/rho_name_output.rho")',
            "mrho",

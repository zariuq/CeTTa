...
MECHANISM_MACHINE_COUNTERS = (
    ...
    "candidate_snapshot_records_examined",
    "candidate_snapshot_candidates",
    "equation_candidates",
    "equation_candidates_shape_pruned",
    "match_decision_runs",
    "match_decision_equation_inputs",
    "match_decision_equation_survivors",
    ...
    "equation_binding_merge_calls",
    "equation_binding_merge_source_items",
    "equation_binding_merge_logical_writes",
    "equation_binding_merge_failures",
    "binding_apply_calls",
    ...
    "deterministic_equation_choices_elided",
    "rollbacks",
    "answers",
    ...
    "owned_continuation_capture_attempts",
    "owned_continuation_captures",
    "owned_continuation_capture_deferred",
    "owned_continuation_capture_unsupported",
    "owned_continuation_capture_invalidated",
    "owned_continuation_restores",
    "owned_continuation_restore_invalidated",
    ...
    "owned_continuation_expansion_successors",
    "owned_continuation_expansion_deferred",
    "owned_continuation_expansion_unsupported",
    "owned_continuation_expansion_invalidated",
    "owned_continuation_expansion_capacity",
...
MECHANISM_RUNTIME_COUNTERS = (
    ...
    *SURVIVOR_ALLOCATION_ROLE_COUNTERS,
    ...
    "petta-equation-guard-prune-attempt",
    "petta-equation-guard-pruned",
    "petta-equation-guard-retained",
    "petta-equation-activation-plan-admitted",
    "petta-equation-activation-plan-declined-malformed",
    "petta-equation-activation-plan-declined-chain",
    "petta-equation-activation-plan-declined-translator",
    "petta-equation-activation-plan-declined-depth",
    "petta-equation-activation-plan-declined-active-data",
    "petta-equation-activation-plan-declined-relation-effect",
)

...
} PPCertificateGSLTRelationalProjectionStorageV1;
...
void ppcertificate_gslt_relational_projection_v1_free(
    PPCertificateGSLTRelationalProjectionV1 *projection) {
    PPCertificateGSLTRelationalProjectionStorageV1 *storage;
    uint32_t index;
    ...
    ppcertificate_gslt_relational_projection_v1_init(projection);
}
...
PPCertificateGSLTArticleV1Result ppcertificate_gslt_relational_projection_v1_read(
    ...
    PPCertificateGSLTRelationalProjectionV1 result;
    PPCertificateGSLTRelationalProjectionStorageV1 *storage = NULL;
    ...
    ppcertificate_gslt_relational_projection_v1_init(&result);
    ...
    for (answer_index = 0u; answer_index < storage->answers.len;
        ...
        if (ppproof_projection_v1_expr_head(
            ...
            identity_seen = true;
                       ...
                       record, "proof-relational-projection-table-v1", 5u)) {
            PPCertificateGSLTRelationalProjectionTableV1 *table =
            ...
            PPCertificateGSLTRelationalProjectionSelectorV1 *selector =
    ...
    ppcertificate_gslt_relational_projection_v1_free(projection);
    *projection = result;
...
PPCertificateGSLTArticleV1Result ppcertificate_gslt_relational_projection_v1_bind_state(
    ...
    for (index = 0u; index < projection->table_len; index++) {
        const PPCertificateGSLTRelationalProjectionTableV1 *table =

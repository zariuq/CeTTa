#ifndef CETTA_GSLT2PARSE_CERTIFICATE_GSLT_RELATIONAL_RUNTIME_V1_H
#define CETTA_GSLT2PARSE_CERTIFICATE_GSLT_RELATIONAL_RUNTIME_V1_H
...
} PPCertificateGSLTRelationalRuntimeV1Receipt;
...
typedef struct {
    ...
    PPOSLFNativeVMStatsV1 stats;
} PPCertificateGSLTRelationalRuntimeV1Profile;

typedef struct {
    void *implementation;
} PPCertificateGSLTRelationalRuntimeV1;

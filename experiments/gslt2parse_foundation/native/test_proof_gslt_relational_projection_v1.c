...
static bool name_equal(PPProofGSLTNameV1 left, PPProofGSLTNameV1 right) {
...
static bool make_state_plan(
    const PPProofGSLTRelationalProjectionV1 *projection,
    ...
    for (index = 0u; index < projection->table_len; index++) {
        const PPProofGSLTRelationalProjectionTableV1 *source =
...
int main(int argc, char **argv) {
    SymbolTable symbols;
    PPProofGSLTRelationalProjectionV1 first;
    PPProofGSLTRelationalProjectionV1 second;
    PPProofGSLTRelationalProjectionV1 invalid;
    ...
    ppproof_gslt_relational_projection_v1_init(&first);
    ppproof_gslt_relational_projection_v1_init(&second);
    ppproof_gslt_relational_projection_v1_init(&invalid);
    ...
    result = ppproof_gslt_relational_projection_v1_read(
    ...
    result = ppproof_gslt_relational_projection_v1_bind_state(
    ...
    ppproof_gslt_relational_projection_v1_free(&invalid);
    ppproof_gslt_relational_projection_v1_free(&second);
    ppproof_gslt_relational_projection_v1_free(&first);

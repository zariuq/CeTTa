...
sed "s|langdef/bnf/ebnf_derivation_projection_v1.metta|$ebnf_evidence/mutated-projection.metta|g" \
...
sed "s|langdef/bnf/ebnf_derivation_projection_v1.metta|$ebnf_evidence/mutated-iteration-order.metta|g" \

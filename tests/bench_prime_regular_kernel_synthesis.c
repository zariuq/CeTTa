...
int main(int argc, char **argv) {
    ...
    if (strcmp(workload, "identity") == 0) {
        judgment_text = "(type:of (Lam U0 (idx 0)))";
        expected_status = "Established";
    } else if (strcmp(workload, "scoped-identity") == 0) {
        judgment_text =
            "(type:of (PrimeScoped PrimeCtxNil (Lam U0 (idx 0))))";
        expected_status = "Established";
    } else if (strcmp(workload, "refuted") == 0) {
        judgment_text = "(type:of U1)";
        expected_status = "Refuted";
    } else if (strcmp(workload, "scoped-refuted") == 0) {
        judgment_text = "(type:of (PrimeScoped PrimeCtxNil U1))";
        expected_status = "Refuted";
    } else if (strcmp(workload, "control") == 0) {
        judgment_text = "(type:of 7)";
        expected_status = "Established";
    } else {

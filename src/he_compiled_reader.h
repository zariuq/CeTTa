#ifndef CETTA_HE_COMPILED_READER_H
#define CETTA_HE_COMPILED_READER_H
...
typedef struct HECompiledReaderV1 HECompiledReaderV1;
...
#endif /* CETTA_HE_COMPILED_READER_H */

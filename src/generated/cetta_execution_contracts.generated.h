...
#define CETTA_GSLT_PREPARED_PURE_INTRINSIC_HEAD_ROWS(X)     X(op_div, 2u, CETTA_GSLT_PREPARED_PURE_INTRINSIC_OPERANDS_STRICT_ALL, CETTA_GSLT_PREPARED_PURE_INTRINSIC_GROUNDED_DISPATCH) \

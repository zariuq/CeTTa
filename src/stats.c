...
static const char *const CETTA_RUNTIME_COUNTER_NAMES[CETTA_RUNTIME_COUNTER_COUNT] = {
    ...
    "prepared-pure-decision-equation-input",
    "prepared-pure-decision-equation-survivor",
    ...
    "match-decision-run",
    "match-decision-equation-input",
    "match-decision-equation-survivor",
    ...
    "match-rule-frame-region-borrow-attempt",
    "match-rule-frame-region-borrow-direct",
    "match-rule-frame-region-borrow-general",
    "match-rule-frame-region-direct-read",
    ...
    "match-bind-stored-equation-context-store",
    "match-bind-activation-source-context-store",
    "match-bind-stored-equation-transport-root",
    "match-bind-stored-equation-transport-allocated-bytes",
    "match-bind-activation-source-transport-root",
    "match-bind-activation-source-transport-allocated-bytes",
    ...
    "petta-program-revision-view-authority-equation-copy",
    ...
    "petta-equation-projection-promoted-records",
    "petta-equation-projection-promoted-bytes",
    ...
    "unification-attempt",
    "unification-attempt-head-fail",
    "unification-attempt-repeated-var-fail",
    "unification-attempt-success",
    "match-pin-resolved-pattern",
    "activation-frame-prefix-reuse",
    "match-query-slot-lookup",
    "match-query-slot-hit",
    "match-query-slot-absent",
    "match-leftover-hash",
    "match-leftover-hash-hit",
    "match-leftover-frame-owned",
    "match-leftover-unframed-plain",
    "match-leftover-unframed-epoch",
    "match-decoded-lookup",
    "match-decoded-in-frame",
    "match-shared-open-reflexivity-commit",
    "bindings-frame-directory-detach",
    "bindings-frame-storage-detach",
    "bindings-frame-storage-copied-slot",
    "bindings-frame-registration",
    "bindings-frame-claimed-generic-row",
    "bindings-frame-count-peak",
    "bindings-frame-storage-alloc",
    "bindings-frame-storage-reuse",
    "bindings-frame-prune",
    "bindings-frame-prune-candidate",
    "bindings-frame-prune-value-scan",
    "bindings-frame-prune-atom-scan",
    "bindings-frame-prune-retain",
    "bindings-frame-prune-recycle",
    "bindings-frame-prune-context-reference",
    "bindings-frame-prune-materialized-reference",
    "bindings-frame-context-store-owned",
    "bindings-frame-context-store-unowned",
    "bindings-materialized-epoch-value-store",
    "bindings-materialized-epoch-value-count-peak",
    "bindings-frame-prune-materialized-environment",
    "match-bind-stored-equation-materialized-epoch-store",
    "match-bind-activation-source-materialized-epoch-store",
    "bindings-lookup-frame-coordinate",
    "bindings-lookup-generic-map",
    "bindings-lookup-plain-identity",
    "bindings-lookup-unowned-contextual",
    "bindings-frame-registration-known",
    "bindings-frame-registration-new",
    "bindings-frame-registration-extended",
    "unification-attempt-after-bind-fail",
    "bindings-frame-directory-lookup",
    "bindings-frame-directory-hit",
    "bindings-frame-directory-newest-hit",
    "bindings-frame-directory-newest-eight-hit",
    "bindings-frame-directory-newest-two-hit",
    "bindings-frame-directory-newest-four-hit",
    "petta-ready-apply-call-first",
    "petta-ready-apply-call-second",
    "petta-ready-apply-host-first",
    "petta-ready-apply-host-second",
    "petta-ready-apply-other-first",
    "petta-ready-apply-other-second",
    "petta-ready-rewrite-call-first",
    "petta-ready-rewrite-call-second",
    "petta-ready-rewrite-host-first",
    "petta-ready-rewrite-host-second",
    "petta-ready-rewrite-other-first",
    "petta-ready-rewrite-other-second",
    "match-decision-discriminator-unbound-skip",
    "match-ground-bind-commit",
    "match-ground-bind-decline",
    "space-pinned-occurrences-detach",
    "space-pinned-occurrences-detached-row",
    "petta-answer-producer-choice",
    "petta-answer-producer-answer",
    "petta-answer-producer-handoff",

...
typedef PettaAnalysisBoundaryFacts PettaTypecheckBoundaryFacts;
#define PETTA_TYPECHECK_BOUNDARY_FACT_NONE PETTA_ANALYSIS_BOUNDARY_FACT_NONE
#define PETTA_TYPECHECK_BOUNDARY_FACT_NONVAR PETTA_ANALYSIS_BOUNDARY_FACT_NONVAR
#define PETTA_TYPECHECK_BOUNDARY_FACT_PROPER_LIST PETTA_ANALYSIS_BOUNDARY_FACT_PROPER_LIST
#define PETTA_TYPECHECK_BOUNDARY_FACT_NONEMPTY_EXPRESSION PETTA_ANALYSIS_BOUNDARY_FACT_NONEMPTY_EXPRESSION
